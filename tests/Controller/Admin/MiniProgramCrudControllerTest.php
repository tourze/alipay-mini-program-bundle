...
/**
 * MiniProgramCrudController 的单元测试
 */
class MiniProgramCrudControllerTest extends TestCase
{
    private MiniProgramCrudController $controller;

    protected function setUp(): void
    {
        $this->controller = new MiniProgramCrudController();
    }
