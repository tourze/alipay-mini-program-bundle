...
/**
 * TemplateMessageCrudController 的单元测试
 */
class TemplateMessageCrudControllerTest extends TestCase
{
    private TemplateMessageCrudController $controller;

    protected function setUp(): void
    {
        $this->controller = new TemplateMessageCrudController();
    }
