...
/**
 * AuthCodeCrudController 的单元测试
 */
class AuthCodeCrudControllerTest extends TestCase
{
    private AuthCodeCrudController $controller;

    protected function setUp(): void
    {
        $this->controller = new AuthCodeCrudController();
    }
    ...
    {
        $this->assertEquals(AuthCode::class, AuthCodeCrudController::getEntityFqcn());
    }
