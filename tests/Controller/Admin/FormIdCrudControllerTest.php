...
/**
 * FormIdCrudController 的单元测试
 */
class FormIdCrudControllerTest extends TestCase
{
    private FormIdCrudController $controller;

    protected function setUp(): void
    {
        $this->controller = new FormIdCrudController();
    }
    ...
    {
        $this->assertEquals(FormId::class, FormIdCrudController::getEntityFqcn());
    }
